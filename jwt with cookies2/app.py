...
def login():
    ...
    response.set_cookie('access_token', token, expires=datetime.datetime.utcnow() + datetime.timedelta(minutes=10), httponly=True, secure=True)  # Secure should be True in production with HTTPS
